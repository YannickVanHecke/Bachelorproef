...
blijkt dat de mobiele applicatie minder gegevens verbruikt in vergelijking met de responsive webapplicatie. Mogelijk is dit te verklaren door dat
de mobiele applicatie enkel de data die weergegeven wordt, wordt opgehaald. Dit in tegenstelling tot de responsive webapplicatie, waarbij er ook nog html en css opgehaald wordt.

\addcontentsline{lot}{table}{Gemiddeld gegevensverbruik bij het inloggen, gegevens ophalen en tonen in de browser}
\begin{center}
  \begin{tabular}{| l | l | l |}
    \hline
