...
\input{inleiding} %% 1
\input{methodologie} %% 2

%% Voeg hier je eigen hoofdstukken toe die de ``corpus'' van je bachelorproef
%% vormen. De structuur en titels hangen af van je eigen onderzoek. Je kan bv.
%% elke fase in je onderzoek in een apart hoofdstuk bespreken.

\input{frameworkcrossplatformapp} %% 3
\input{ontwikkelingcrossplatformapp} %% 4
\input{frameworkresponsivewebsite} %% 5
\input{ontwikkelingresponsivewebsite} %% 6
\input{resultatencrossplatformapp} %% 7
\input{resultatenresponsivewebsite} %% 8
\input{conclusie} %% 9
