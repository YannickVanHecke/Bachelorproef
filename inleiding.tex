...
Momenteel zijn er in de vakliteratuur artikelen te vinden over een vergelijkende studie tussen mobiele applicatie
...
Toch zijn deze wetenschappelijke artikelen beschikbaar. Zo onderzochten Paulo R. M. de Andrade en Adriano B. Albuquerque
in het artikel "CROSS PLATFORM APP A COMPARATIVE STUDY" ~\autocite{paulor.m.deandradeandrianob.albuquerque2015}
...
die gebaseerd zijn op deze technologie.

Anderzijds kan men ook opteren voor een cross-platforme mobiele applicatie te bouwen op basis van html, css en javascript.
