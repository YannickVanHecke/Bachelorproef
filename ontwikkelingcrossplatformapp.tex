...
Op deze manier worden de gegevens omgezet naar JSON \footnote{De afkorting staat \citep{inleidingtotjson2017} staat voor
...
De volledige code met uitgebereide stappen om dit voorbeeld te ontwikkelen is beschikbaar op \citep{buildappwithnativeuiusingxamarininvisualstudio2017}.
